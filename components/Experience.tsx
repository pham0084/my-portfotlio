    ...
    >
      ...
      <div className='w-full flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar-thin scrollbar-track-[#EEEEEE]/20 scrollbar-thumb-[#5C9EAD]/30'>
          <ExperienceCard
            ...
            startDate='Aug 2022'
            endDate='Present'
            description= {['•	Built a website with team for IES NTU Student Branch using Node.js and Reactjs, published through GitHub’s platform'
          ...
          <ExperienceCard
            ...
            startDate=' Aug 2021'
            endDate='May 2025 '
            description= {['• Specialized in Info-Communications Engineering (Computer Engineering)', '• Member of EEE Inter School Game Soccer Team', '• Member of Inter Hall XV Soccer Team',
